...
<div id="bd">
	<div id="yui-main">
	<div class="yui-b">
	<h2><s:if test="uuid == null">创建</s:if><s:else>修改</s:else>用户</h2>
	<form id="inputForm" action="user!save.action" method="post">
		...
		<table class="noborder">
			...
			<tr>
				<td>角色:</td>
				<td>
					<s:checkboxlist name="checkedRoleIds" list="allRoleList" listKey="uuid" listValue="name" theme="custom"/>
				</td>
			</tr>
			<tr><td><textarea id="editor_1" name="content" style="width:780px;height:450px;visibility:hidden;"></textarea></td></tr>
			<tr>
				<td colspan="2">
