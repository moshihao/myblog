...
public class User extends IdEntity {
	...
	@ManyToMany
	//中间表定义,表名采用默认命名规则
	@JoinTable(name = "BLOG_USER_ROLE", joinColumns = { @JoinColumn(name = "USER_UUID") }, inverseJoinColumns = { @JoinColumn(name = "ROLE_UUID") })
	//Fecth策略定义
	...
	public List<String> getRoleIds() {
		return ConvertUtils.convertElementPropertyToList(roleList, "uuid");
	}
