...
import cn.moshihao.functional.Gui.UserColumn;
...
public class UserManagerTest extends BaseFunctionalTestCase {
	...
	public void createUser() {
		...
		for (Role role : user.getRoleList()) {
			driver.findElement(By.id("checkedRoleIds-" + role.getUuid())).setSelected();
		}
	...
	public void editUser() {
		...
		for (Role role : testUser.getRoleList()) {
			SeleniumUtils.uncheck(driver.findElement(By.id("checkedRoleIds-" + role.getUuid())));
		}
	...
	private void verifyUser(User user) {
		...
		for (Role role : user.getRoleList()) {
			assertTrue(driver.findElement(By.id("checkedRoleIds-" + role.getUuid())).isSelected());
		}
		...
		for (Role role : uncheckRoleList) {
			assertFalse(driver.findElement(By.id("checkedRoleIds-" + role.getUuid())).isSelected());
		}
	}
